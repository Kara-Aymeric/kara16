...
class SaleOrder(models.Model):
    ...
    customer_invoice_number = fields.Char(
        ...
        help="Allows you to attach the customer invoice number generated by the manufacturer to the odoo quote. "
             "The value is retrieved to create the commission wording associated with the sale"
    )
