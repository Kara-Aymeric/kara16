...
class API(object):
    ...
    def call(self, type, resource_path, data,filters=None):
        """
        ...
        response = requests.request(type, resource_path, headers=headers, data=payload,params=filters, verify=self.verify_ssl)
    ...
    def search(self, ressource, filters, offset=0, limit=None):
        ...
        items = self.call('GET', ressource, {},filters)
